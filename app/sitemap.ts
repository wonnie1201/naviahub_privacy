...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://naviahub.dev/marriagegirl', changeFrequency: 'weekly', priority: 0.8 },
    { url: 'https://naviahub.dev/marriagegirl/test/1', changeFrequency: 'weekly', priority: 0.8 },
    { url: 'https://naviahub.dev/marriagegirl/test/2', changeFrequency: 'weekly', priority: 0.8 },
    { url: 'https://naviahub.dev/marriagegirl/test/3', changeFrequency: 'weekly', priority: 0.8 },
    { url: 'https://naviahub.dev/marriagegirl/result', changeFrequency: 'weekly', priority: 0.8 },
